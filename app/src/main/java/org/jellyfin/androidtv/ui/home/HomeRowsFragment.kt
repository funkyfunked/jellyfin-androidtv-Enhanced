    ...
    userSettingPreferences.get(userSettingPreferences.homesection9)
			...
			withContext(Dispatchers.Main) {
				...
				if (userSettingPreferences.get(userSettingPreferences.showMyCollectionsRow)) {
					helper.loadMyCollectionsRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}

				// Add genre rows matching the settings order
				if (userSettingPreferences.get(userSettingPreferences.showFavoritesRow)) {
					helper.loadFavoritesRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showSciFiRow)) {
					helper.loadSciFiRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showRomanceRow)) {
					helper.loadRomanceRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showAnimeRow)) {
					helper.loadAnimeRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showActionRow)) {
					helper.loadActionRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showActionAdventureRow)) {
					helper.loadActionAdventureRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showComedyRow)) {
					helper.loadComedyRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showDocumentaryRow)) {
					helper.loadDocumentaryRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
				if (userSettingPreferences.get(userSettingPreferences.showRealityTvRow) || userSettingPreferences.get(userSettingPreferences.showRealityRow)) {
					helper.loadRealityRow().addToRowsAdapter(requireContext(), cardPresenter, adapter as MutableObjectAdapter<Row>)
				}
